...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Smoke-test the GStreamer UVC recorder.")
    ...
    try:
        for i in range(args.loops):
            ...
            sync_info = recorder.run(loop_index, loop_monotonic_ns, loop_wall_time)
            print(f"Loop {loop_index}: Sync info: {sync_info}", end="\r")
    finally:
        recorder.shutdown()
